...
# виконати логін
# дістати зображення з модуля get_image функції get_image_formats_by_id

# передати результати сюди в змінні 
# (зі сканера вертається словник словників {})

# віддати в дбменеджер який виконає запис в базу

# тести з папки тестс 
# виконають перевірку на відповідність хеша з наявним локально зображенням
